                    ...
                    <thead class="text-dark fs-4">
                      <tr class="bg-dark">
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0 text-white">#</h6>
                        </th>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0 text-white"> Unit</h6>
                        </th>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0 text-white sortt">Bagian</h6>
                        </th>
                        <th class="border-bottom-0">                         
                        </th>                       
                      </tr>
                          ...
                          <div class="d-flex align-items-center gap-2">
                            <div class="dropdown dropstart">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  <li>
                                  <span class="bg-dark  dropdown-item d-flex align-items-center gap-3 text-white" >{{ $data->bagian }}</span>
                                </li>
                                <li>
                                  <a class="dropdown-item d-flex align-items-center gap-3 text-primary" href="{{ route('bagian.edit',$data->id) }}"><i class="fs-4 ti ti-edit"></i>Edit</a>
                                </li>
                                <li>
