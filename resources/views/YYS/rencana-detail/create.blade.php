@extends('yys.sidebar')
@section('title')Rencana Anggaran Belanja - RAB - Uraian Kegiatan - YYS @endsection
            ...
            <div class="row">        
              <div class="col-lg-3">
                 <div class="text-center">
                    <a href="{{ route('rencana-detail.index', $rencana_id) }}" class="btn btn-dark mb-2">Kembali</a>                            
              ...
              <div class="col-lg-9">
                <div class="card">
                  <div class="card-body">
                          ...
                          @endif
                        <form action="{{route('rencana-detail.store', ['rencana_id' => $rencana_id,'subbagian' => $subbagian])}}" method="POST">
                          @csrf
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="border-bottom-0">
                                    ...
                                    <form action="{{ route('rencana-detail.destroy', ['rencana_id' => $rencana_id, 'subbagian' =>  $subbagian->id, 'rencana_detail' => $data->id]) }}" method="POST">
                                      @csrf
                                      @method('DELETE')                
