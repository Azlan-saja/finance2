@extends('yys.sidebar')
@section('title')Edit Sasaran - YYS @endsection
...
<div class="container mt-4">
    ...
    <div class="card mb-0">
        <div class="card-body p-4">
            <!-- ISI START -->
                <a href="{{ route('sasaran.index') }}" class="btn btn-dark m-1">Kembali</a>
                <hr>
                 ...
                 <form action="{{ route('sasaran.update',$sasaran->id) }}" method="POST">
                    ...
                    <div class="form-body">                     
                      <div class="mb-3">
                            <div class="row">
                                <label class="col-lg-1 form-label pt-2">Sasaran</label>                         
                              <div class="col-md-11">
                                <input type="text" class="form-control  @error('sasaran') is-invalid @enderror" name="sasaran" value="{{ $sasaran->sasaran }}" required>
                                  @error('sasaran')
