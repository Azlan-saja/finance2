@extends('yys.sidebar')
@section('title')Edit Kegiatan - YYS @endsection
...
<div class="container mt-4">
    ...
    <div class="card mb-0">
        <div class="card-body p-4">
            <!-- ISI START -->
                <a href="{{ route('kegiatan.index') }}" class="btn btn-dark m-1">Kembali</a>
                <hr>
                 ...
                 <form action="{{ route('kegiatan.update',$kegiatan->id) }}" method="POST">
                    ...
                    <div class="form-body">                     
                      <div class="mb-3">
                            <div class="row">
                                <label class="col-lg-1 form-label pt-2">Kegiatan</label>                         
                              <div class="col-md-11">
                                <input type="text" class="form-control  @error('kegiatan') is-invalid @enderror" name="kegiatan" value="{{ $kegiatan->kegiatan }}" required>
                                  @error('kegiatan')
