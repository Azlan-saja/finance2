@extends('yys.sidebar')
@section('title')Satuan - YYS @endsection
...
@endphp
  <div class="container mt-4">
              ...
              <div class="card mb-0">
                ...
                <!-- ISI START -->
                <a href="{{ route('satuan.create') }}" class="btn btn-primary m-1">Tambah</a>
                <a href="{{ route('satuan.index') }}" class="btn btn-outline-primary m-1">Segarkan</a>
                <a href="{{ route('laporan.satuan') }}" target="_blank" class="btn btn-outline-danger m-1 position-absolute end-0 me-4">Cetak</a>                
                <hr>
                   @if ($message = Session::get('success'))
                    ...
                    @endif
                  <form action="{{ route('satuan.search') }}" method="POST">
                     @csrf               
                  ...
                  <table class="table border text-nowrap customize-table mb-0 align-middle table-striped">
                    <thead class="text-dark fs-4">
                      <tr class="bg-dark">
                        ...
                        <th class="border-bottom-0">                          
                            <a class="fw-semibold mb-0 text-white" href="{{ route('satuan.index', ['sort' => 'satuan', 'order' => $order == 'asc' ? 'desc' : 'asc']) }}">
                          ...
                          <div class="d-flex align-items-center gap-2">
                            <div class="dropdown dropstart">
                              ...
                              <ul class="dropdown-menu mt-0 pt-0" aria-labelledby="dropdownMenuButton">                               
                                <li>
                                  <span class="bg-dark  dropdown-item d-flex align-items-center gap-3 text-white text-center" >{{$data->satuan }}</span>
                                </li>
                                <li>
                                  <a class="dropdown-item d-flex align-items-center gap-3 text-warning" href="{{ route('satuan.edit',$data->id) }}"><i class="fs-4 ti ti-edit"></i>Edit</a>
                                </li>
                                <li>
