...
@section('title')Beban - {{ Auth::user()->type }} @endsection
...
@endphp
  <div class="container mt-4">
              ...
              <div class="card mb-0">
                ...
                <!-- ISI START -->
                <a href="{{ route('user.beban.create') }}" class="btn btn-primary m-1">Tambah</a>
                <a href="{{ route('user.beban.index') }}" class="btn btn-outline-primary m-1">Segarkan</a>
                ...
                <hr>
                   @if ($message = Session::get('success'))
                    ...
                    @endif
                  <form action="{{ route('user.beban.search') }}" method="POST">
                     @csrf               
                          ...
                          <div class="d-flex align-items-center gap-2">
                            <div class="dropdown dropstart">
                              ...
                              <ul class="dropdown-menu mt-0 pt-0" aria-labelledby="dropdownMenuButton">                               
                                ...
                                <li>
                                  <a class="dropdown-item d-flex align-items-center gap-3 text-warning" href="{{ route('user.beban.edit',$data->id) }}"><i class="fs-4 ti ti-edit"></i>Edit</a>
                                </li>
                                <li>
                                  <form action="{{ route('user.beban.destroy',$data->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')                
