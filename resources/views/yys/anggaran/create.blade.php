@extends('yys.sidebar')
@section('title')Tambah Sumber Anggaran - YYS @endsection
                ...
                <hr>
                 <form action="{{ route('anggaran.store') }}" method="POST">
                    ...
                    <div class="form-body">                     
                      <div class="mb-3">
                            <div class="row">
                                <label class="col-lg-1 form-label">Sumber Anggaran</label>                         
                              <div class="col-md-11">
                                <input type="text" class="form-control  @error('anggaran') is-invalid @enderror" name="anggaran" value="{{ old('anggaran') }}" required>
                                  @error('anggaran')
