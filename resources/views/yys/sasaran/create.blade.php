@extends('yys.sidebar')
@section('title')Tambah Sasaran - YYS @endsection
                    ...
                    <div class="form-body">                     
                      <div class="mb-3">
                            <div class="row">
                              ...
                              <div class="col-md-11">
                                <input type="text" class="form-control  @error('sasaran') is-invalid @enderror" name="sasaran" value="{{ old('sasaran') }}" required>
                                  @error('sasaran')
