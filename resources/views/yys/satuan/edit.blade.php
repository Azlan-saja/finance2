@extends('yys.sidebar')
@section('title')Edit Satuan - YYS @endsection
...
<div class="container mt-4">
    ...
    <div class="card mb-0">
        <div class="card-body p-4">
            <!-- ISI START -->
                <a href="{{ route('satuan.index') }}" class="btn btn-dark m-1">Kembali</a>
                <hr>
                 ...
                 <form action="{{ route('satuan.update',$satuan->id) }}" method="POST">
                    ...
                    <div class="form-body">                     
                      <div class="mb-3">
                            <div class="row">
                                <label class="col-lg-1 form-label pt-2">Satuan</label>                         
                              <div class="col-md-11">
                                <input type="text" class="form-control  @error('satuan') is-invalid @enderror" name="satuan" value="{{ $satuan->satuan }}" required>
                                  @error('satuan')
