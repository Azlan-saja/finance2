...
@section('title')History Detail - Rencana Anggaran Belanja - RAB - {{ Auth::user()->type }} @endsection
                    ...
                    <thead class="text-dark fs-4" style="position:sticky;top:0;">
                      <tr class="bg-dark">
                        ...
                        <th class="border-bottom-0 fw-semibold mb-0 text-white align-middle">  
                         ...
                         <th class="border-bottom-0 fw-semibold mb-0 text-white text-wrap">  
                          Jumlah Sasaran                       
                        </th>                                                                                                                                    
                        <th class="border-bottom-0 fw-semibold mb-0 text-white text-wrap">  
                          Harga Satuan                     
                                 ...
                                 <td class="bg-info border-0">
                                  ...
                                  @forelse($data2->kegiatan as $data3)
                                            <tr>                                              
                                              ...
                                              <td class="bg-info text-white border-0">{{ $data->index+1 }}.{{ $loop->parent->iteration }}.{{ $loop->iteration }}</td>
